<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ViewProReferrals.aspx.cs" Inherits="ReferLocals.ViewProReferrals" %>
            ...
            <div class="col-md-9">
                ...
                <div class="row pull_1">
                    <div class="col-md-8 col-sm-12">
                        <div class="pullR">
                            <h4>People who Provided Strong Referral for <strong>
    ...
    <script type="text/javascript">
     $(document).ready(function () {
        ...
        function ShowReferList(type) {
            ...
            index = index + 1;
            $.ajax({
                url: '/ViewProReferrals.aspx/GetReferList',
                type: "POST",
