<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddTestimonial.aspx.cs" Inherits="ReferLocals.Admin.AddTestimonial" %>
    ...
    <script>
        function EditTestimonial(btn) {
            ...
            if (isapprovedbyadmin == "True") {
                $('#<%=chkTestimonial.ClientID%>').prop("checked", true);
            ...
            $('.IconImage').append('<img src="<%=DataAccess.HelperClasses.Common.TestimonialImagesPath%>' + image + '"/>');
            $("#divGridTestimonial").addClass("hide");
            $("#divAddTestimonial").removeClass("hide");
        }
        ...
        function AddTestimonial() {
            $('#<%=chkTestimonial.ClientID%>').prop("checked", false);
        ...
        function DisableTestimonial(btn) {
            var id = $(btn).attr('data-id');
            var Approved = $(btn).attr('data-isapprovedbyadmin');
            $.ajax({
                url: '/Admin/AddTestimonial.aspx/DisableTestimonial',
                type: "POST",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content" id="divGridTestimonial">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><span>Testimonial List</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- END PAGE HEADER-->
                            ...
                            <div class="row rowPadding">
                                <div class="col-md-6 col-sm-12">
                                    <div class="btn-group btn-group-solid">
                                        <a class="btn btn-lg red" style="cursor: pointer" onclick="return AddTestimonial();"><i class="fa fa-plus"></i>Add New Testimonial </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable no-footer">
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptTestimonial" runat="server">
                                                <ItemTemplate>
                                                    <tr data-name="<%#Eval("Name") %>">
                                                        <td><%#Eval("SNO") %> </td>
                                                        <td><a class="linktext" href="#"><%#Eval("Id") %> </a></td>
                                                        <td><a class="linktext" href="#">
                                                            <img src="<%=DataAccess.HelperClasses.Common.TestimonialImagesPath %><%#Eval("Image") %>?width=50&height=50" alt="<%#Eval("Image") %>">
                                                        </a></td>
                                                        <td><a class="linktext" href="#"><%#Eval("Name") %> </a></td>
                                                        ...
                                                        <td class="ancherwidth ancherwidth2"><a onclick="EditTestimonial(this);" data-id="<%#Eval("Id") %>" data-name="<%#Eval("Name") %>" data-description="<%#Eval("Description") %>" data-image="<%#Eval("Image") %>" data-isapprovedbyadmin="<%#Eval("IsApprovedByAdmin") %>" style="cursor: pointer" class="btn dark btn-sm btn-outline sbold uppercase"><i class="fa fa-edit"></i>Edit </a>
                                                            <a style='cursor: pointer;' class="btn <%#(Convert.ToBoolean(Eval("IsApprovedByAdmin"))==true?"dark":"red")%>   btn-sm btn-outline sbold uppercase" onclick="return DisableTestimonial(this);" data-id="<%#Eval("Id") %>" data-isapprovedbyadmin="<%#Eval("IsApprovedByAdmin") %>"><i class="fa fa-trash-o"></i><%#(Convert.ToBoolean(Eval("IsApprovedByAdmin"))==true?"Disable":"Enable")%> </a>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
    ...
    <div class="page-content hide" id="divAddTestimonial">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li><a href="index.html">Home</a> <i class="fa fa-angle-right"></i></li>
                <li><a href="/Admin/AddTestimonial">Testimonial List</a> <i class="fa fa-angle-right"></i></li>
                <li><span>Add New Testimonial</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        ...
        <div class="note note-success homesucess">
            <h3 style="margin-bottom: 0px;">Add New Testimonial</h3>
        </div>
        <div class="row">
            <div class="col-md-12">
                <!-- BEGIN PORTLET-->
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <asp:CheckBox ID="chkTestimonial" runat="server" />
                                    </div>
                                </div>
                            ...
                            <div class="form-actions" style="margin-bottom: 25px;">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="/Admin/AddTestimonial" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
